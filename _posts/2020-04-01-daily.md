...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image002.png)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image004.jpg)

紧接着用 4 个字节的整数来描述模型的三角面片个数，如下所示，即为一个三角得信息。

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image006.jpg)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image008.png)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image010.jpg)

对于obj来说，一个obj格式的文件可能包含了顶点数据，自由形式的曲面／表面属性，绘制索引序列，自由形式的曲面／表面内容声明，关联自由形式的表面，组和渲染属性信息。大多数常见的绘制索引表现为几何顶点，纹理坐标，顶点法线以及多边形的面：

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image012.jpg)

通常处理obj文件的时候，会抛弃顶点法线数据，而通过顶点信息来进行计算。有了以上的顶点坐标、法线、纹理坐标等信息，就可以进行3D模型文件的渲染了。

解析输出为:

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image014.png)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image016.png)

### 配置环境

本人使用的VS2019，在配置环境时，希望能够讲库进行集中管理，因此在E盘单独建立文件夹，将include和lib项放入，并在项目中引入，虽然在后期新建项目中需要重复引入，但是保证了相关文件的整理便捷性。

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image018.jpg)

同时添加依赖项：

 

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image020.jpg)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image022.png)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image024.jpg) ![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image026.jpg)
...
![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image028.jpg)

如下边所示，在main.cpp代码中定义glutMotion()函数，对各个数据进行操作，最后完成对三维体的平移、旋转以及缩放信号。

之后通过glut库函数对控制变量进行输入：

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image030.png)

并且使用glut的库函数，设置鼠标以及键盘事件，完成操作：

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image032.png)

同时，对光纤等材质信息进行绘制。

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image034.png)

在主函数中，可以通过打开文件的方式获取文件的路径，并且通过判断文件路径的“点符号”确定文件类型，然后调用相关的函数，最终完成绘制。

![img](file:///C:/Users/Air/AppData/Local/Temp/msohtmlclip1/01/clip_image036.png)
